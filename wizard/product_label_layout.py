...
class ProductLabelLayout(models.TransientModel):
    ...
    def _prepare_report_data(self):
            ...
            if self.product_ids and len(self.move_line_ids)==0:
                ...
                for i in range(self.custom_quantity):
                    ...
                    for product_code in self.product_ids:
                        ...
                        if product_code.default_code not in dicc_products_price:
                            dicc_products_price[product_code.default_code] = []

                        if product_code.default_code in dicc_products_price:
                            dicc_products_price[product_code.default_code].append({
        ...
        data['dicc_products_price']=dicc_products_price
